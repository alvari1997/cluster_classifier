...
if __name__ == "__main__":
    ...
    calib_data = sorted(glob.glob('/home/alvari/Desktop/dbot_dataset/' + dataset + '_dataset/calib/*.txt'), key=key_func)
    label_data = sorted(glob.glob('/home/alvari/Desktop/dbot_dataset/' + dataset + '_dataset/labels/*.txt'), key=key_func)
    pred_data = sorted(glob.glob('/home/alvari/Desktop/dbot_dataset/' + dataset + '_dataset/pred_lidar/*.txt'), key=key_func)
    ...
    for i in range(len(pred_data)):
        ...
        mlab.savefig('/home/alvari/Desktop/dbot_dataset/' + dataset + '_dataset/imgs/pc_view{}.jpg'.format(i), figure=fig)
        mlab.close(all=True)
        #raw_input()
